<template>
  <section id="faq" class="py-24 px-6 bg-white">
    <div class="container mx-auto">
      <h2 class="text-3xl md:text-5xl font-black text-slate-900 text-center mb-20">Frequently Asked Questions</h2>
...
const faqItems = [
  ...
  { q: "Is the ₹99 price permanent?", a: "No. This is an early bird price for the first 50 registrations only. Price returns to ₹200 after that." },
