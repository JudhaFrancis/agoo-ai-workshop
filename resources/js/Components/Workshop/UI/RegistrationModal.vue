<template>
  <transition enter-active-class="transition duration-300 ease-out" enter-from-class="opacity-0"
    ...
    <div v-if="isOpen" class="fixed inset-0 z-[100] flex items-center justify-center p-0 md:p-6 overflow-y-auto">
      <div @click="$emit('close')" class="fixed inset-0 bg-slate-900/60 backdrop-blur-sm" />
      ...
      <transition enter-active-class="transition duration-300 ease-out"
        ...
        <div
          class="w-full max-w-4xl relative z-10 bg-white md:rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row md:max-h-[90vh]">
          <!-- Sidebar: Workshop Info -->
          <div
            class="w-full md:w-[320px] bg-slate-50 border-r border-slate-100 p-8 md:p-10 flex flex-col justify-between overflow-y-auto">
            <div class="space-y-6">
              ...
              <div class="space-y-5">
                <div class="flex items-start gap-4">
                  <div
                    class="w-9 h-9 rounded-xl bg-white border border-slate-200 flex items-center justify-center shrink-0 shadow-sm">
                    <Calendar class="w-4 h-4 text-violet-600" />
                  </div>
                  <div>
                    <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none mb-1">Date
                    </p>
                    <p class="text-xs font-bold text-slate-700">May 3, 2026</p>
                  </div>
                </div>
                ...
                <div class="flex items-start gap-4">
                  <div
                    class="w-9 h-9 rounded-xl bg-white border border-slate-200 flex items-center justify-center shrink-0 shadow-sm overflow-hidden">
                    <img src="/images/instructor.png" alt="Instructor" class="w-full h-full object-cover" />
                  </div>
                  <div>
                    <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none mb-1">
                      Instructor</p>
                    <p class="text-xs font-bold text-slate-700">Mr. Kishore</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="mt-8 pt-6 border-t border-slate-200">
              <div class="flex items-center justify-between mb-1">
                ...
                <span class="text-xl font-black text-slate-900">₹99</span>
              </div>
              <p class="text-[9px] text-slate-400 font-bold uppercase tracking-widest">Resources & Certificates Included
              </p>
            </div>
          </div>
            ...
            <form @submit.prevent="handleSubmit" class="space-y-6">
              <div class="space-y-1.5">
                ...
                <div class="relative">
                  ...
                  <input type="text" placeholder="e.g. Karthik Ramesh"
                ...
                <p v-if="errors.name" class="text-[9px] text-red-500 font-black uppercase tracking-wider">{{ errors.name
                  }}</p>
              </div>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-1.5">
                  ...
                  <div class="relative">
                    ...
                    <input type="email" placeholder="karthik@agoo.in"
                  ...
                  <p v-if="errors.email" class="text-[9px] text-red-500 font-black uppercase tracking-wider">{{
                    errors.email }}</p>
                </div>
                ...
                <div class="space-y-1.5">
                  ...
                  <div class="relative">
                    ...
                    <input type="tel" placeholder="86102 34644"
                  ...
                  <p v-if="errors.phone" class="text-[9px] text-red-500 font-black uppercase tracking-wider">{{
                    errors.phone }}</p>
                </div>
              </div>
              ...
              <div class="space-y-1.5">
                <label class="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-1">Mailing
                  Address</label>
                <div class="relative">
                  <MapPin class="absolute left-0 top-3 w-4 h-4 text-slate-300" />
                  <textarea placeholder="Complete address for your certificate..." rows="2"
                ...
                <p v-if="errors.address" class="text-[9px] text-red-500 font-black uppercase tracking-wider">{{
                  errors.address }}</p>
              </div>
